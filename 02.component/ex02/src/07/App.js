...
ReactModal.setAppElement('body');   // 바깥에 꼭 해야함!
    ...
    return (
        <Fragment>
            ...
            <Modal
                ...
                onRequestClose={ () => setModal02IsOpen(false) }    // 모달 바깥을 눌렸을 때 꺼지도록!!
            ...
            <Modal
                ...
                shouldCloseOnOverlayClick={ false } // overlay를 클릭해도 닫히지 않음
            ...
            <Modal
                ...
                shouldCloseOnOverlayClick={ true } // overlay를 클릭해면 닫힘
                style={{
                    overlay: {
